...
const SpecialsCard = () => {
    const specialMenus = [
        ...
        },
        {
            ...
            title: "Bruschetta",
            price: "$5.99",
            description: "Our Bruschetta is made from grilled bread that has been smeared with garlic and seasoned with salt and olive oil, perfect for an evening dinner.",
            order: "Order a delivery"
        },
        {
            image: Dessert3,
