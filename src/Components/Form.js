...
const schema = yup.object({
    ...
    guests: yup.number().required("Please specify number of guests per table!").min(1, "There must be at least 1 guest!"),
        ...
        <form onSubmit={handleSubmit(formSubmit)}>
            <fieldset>
                ...
                <div className="field guest">
                    ...
                    <input type="number" placeholder="0" name="guests" {...register("guests")} />
